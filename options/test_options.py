...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--pt_l2_lambda', default=1., type=float, help='weight of mse loss in pt')
		self.parser.add_argument('--pt_lpips_lambda', default=1., type=float, help='weight of lpips loss in pt')
